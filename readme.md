...
--|-----|-------|--------|--
|001|Two Sum
||[001](./leetcode_myself/001.cpp)|brute force|time O(N^2) space O(1)|10%
||[001_hashmap](./leetcode_myself/001_hashmap.cpp) |hashmap|time:O(N),space:O(N) |70%
||[001_binarySearch](./leetcode_myself/001_binarySearch.cpp)|sort+binary search|time:O(NlogN)+O(N)  space:O(N) | 99%
|002|[Add Two Numbers](./leetcode_myself/002.cpp)|math ||100%
|003|Longest Substring Without Repeating Characters
||[003](./leetcode_myself/003.cpp)|brute force|time O(N^2) space O(N)| 51%
||[003_hashmap](./leetcode_myself/003_hashmap.cpp)|hash table| time O(N^2) space O(1)  |51%
||[003_hashtable_twopointer](./leetcode_myself/003_hashtable_twopointer.cpp)|hash table + two pointer|time O(N) space O(N) |100%
|004|[Median of Two Sorted Arrays 004_BinarySearch](./leetcode_myself/004_BinarySearch.cpp)|binary search|O(log(min(m+n)))|99%
|005|Longest Palindromic Substring
||[005](./leetcode_myself/005.cpp)|brute force|time O(N^3) space O(1)| 23%
||[005_dp](./leetcode_myself/005_dp.cpp)|dp|time O(N^2) space O(N^2) |48%
|006|[ZigZag Conversion](./leetcode_myself/006.cpp)||time O(N) space O(N)|  20 ms, 77.62%
|007|[Reverse Integer](./leetcode_myself/007.cpp)|int| time O(1) space O(1)|98%
|008|[String to Integer (atoi)](./leetcode_myself/008.cpp) |string|time O(N) space O(1)| 100%
...
|010|[Regular Expression Matching](./leetcode_myself/010.cpp)|dp|time:O(M*N) space:O(M *N)|72%
|011|Container With Most Water
||[011](./leetcode_myself/011.cpp)|brute force|time:O(N^2)| 40%
||[011_twoPointer](./leetcode_myself/011_twoPointer.cpp)| two pointer| time:O(N) |100%
...
|026|[Remove Duplicates from Sorted Array](./leetcode_myself/026.cpp)|array | time O(N) space O(1)|  16ms 99%
...
||[028](./leetcode_myself/028.cpp)| BM faster then kmp |time O(N)~worst O(N*M) space O(1)|~0 100%
||[028](./leetcode_myself/028.cpp)| Sunday faster then BM |time O(N)~worst O(M*N) space O(1)|~0 100%
|029|[Divide Two Integers](./leetcode_myself/029.cpp)|math| time:O(log(N)) space:O(1)|12ms 98%
|033|[Search in Rotated Sorted Array](./leetcode_myself/033.cpp)|divide and conquer|time:O(log(N)) space:O(1)|4ms 98%
|034|[Find First and Last Position of Element in Sorted Array](./leetcode_myself/034.cpp)|divide and conquer|time:O(log(N)) space:O(1)|8ms 63%
...
|055|[Jump Game](./leetcode_myself/055.cpp)|greedy|time:O(N)|100%
|056|[Merge Intervals](./leetcode_myself/056.cpp)|greedy|time O(NlgN) space O(1)|8ms 99%
|062|[Unique Paths](./leetcode_myself/062_dp.cpp)|dp|time:O(M*N) space:O(M *N)|100%
|066|[Plus One](./leetcode_myself/066.cpp)|math|time O(N) space O(N)|4ms 36%
|069|[Sqrt(x)](./leetcode_myself/069.cpp)|binary search|time:O(NlogN)| 98%
...
|091|Decode Ways
||[091_RecursionWithMemorization](./leetcode_myself/091_RecursionWithMemorization.cpp)|dfs+memorize|time O(N^2),space:O(N^2)|31%
||[091_dp](./leetcode_myself/091_dp.cpp)|dp|time:O(N) space:O(1)|100%
...
|105|[Construct Binary Tree from Preorder and Inorder Traversal](./leetcode_myself/105.cpp)|recursion |time O(N) space O(N)|100%
...
|139|[Word Break](./leetcode_myself/139.cpp)|dp|time:O(N^2) space:O(N)|100%
...
|152|[Maximum Product Subarray](./leetcode_myself/152.cpp)|dp |time:O(N) space:O(1)|100%
...
|162|[Find Peak Element](./leetcode_myself/162.cpp)|binary search|time:O(logN) space:O(1)|4ms 99%
...
|190|[Reverse Bits](./leetcode_myself/190.cpp)|math |time O(1) space O(1)|4ms 88%
|191|[Number of 1 Bits](./leetcode_myself/191.cpp)|math |time O(1) space O(1)|0ms 100%
...
|207|Course Schedule
||[207_dfs](./leetcode_myself/207_dfs.cpp)|dfs, vector / map  |time:O(Node+Edge) |99%
||[207_bfs](./leetcode_myself/207_bfs.cpp)|bfs,queue + vector |time:O(Node+Edge) | 99%
...
|230|[Kth Smallest Element in a BST](./leetcode_myself/230.cpp)|inorder+stack|time:O(N) space:O(N)| 8ms 99%
...
|242|[Valid Anagram](./leetcode_myself/242.cpp)|hash map|time O(N) space O(1)|16ms 36%
...
||[300](./leetcode_myself/300.cpp)|dp|time:O(N^2) space:O(N) |16ms 55%
...
|344|[Reverse String](./leetcode_myself/344.cpp)|string|time O(N) space O(N)|4ms 100%
...
||[350](./leetcode_myself/350.cpp)|sort+two pointer | time: O(max(NlogN,MlogM)) space:O(max(N,M))|8ms 36%
||[350](./leetcode_myself/350.cpp)|map | time:O(N+M) space:O(max(N,M))|4ms 100%
...
|380|[Insert Delete GetRandom O(1)](./leetcode_myself/380.cpp)|hashmap + array ||99%
|384|[Shuffle an Array](./leetcode_myself/384.cpp)| |time O(N) space O(N)| 228ms,48%
|387|[First Unique Character in a String](./leetcode_myself/387.cpp)|hasp map |time O(N) space O(1)|24ms 98%
